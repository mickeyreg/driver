...
#if !defined(VIP2_V1) && !defined (SPARK) && !defined (SPARK7162) && !defined (ADB_BOX) && !defined (CUBEREVO_2000HD) && !defined(SAGEMCOM88) && !defined (ADB5800) && !defined (ADB2850) && !defined (DSI87)
