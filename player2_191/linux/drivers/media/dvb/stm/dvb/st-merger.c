...
#endif
#endif
#if defined(VIP2_V1) || defined(SPARK) || defined(SPARK7162) || defined(IPBOX99) || defined(IPBOX55) || defined(ADB_BOX) || defined(CUBEREVO_2000HD) || defined(SAGEMCOM88) || defined(ADB5800) // none ci targets
	use_cimax = 0;
#endif
	/* first configure sysconfig */
	/* ugly hack: the TSM sometimes seems to stop working, a
...
#elif defined(ADB_BOX) || defined(ARIVALINK200) || defined(ADB5800)
