...
static int stv090x_set_tone(struct dvb_frontend *fe, fe_sec_tone_mode_t tone)
{
	...
	case SEC_TONE_ON:
		#if defined(DSI87)
			lnbh23_t=LNBH23_PCL+LNBH23_TTX+LNBH23_TEN;
...
#if defined(DSI87) || defined(HS7810A) || defined(HS7110) || defined(WHITEBOX) || defined(SPARK)
...
#elif defined(DSI87) // TODO move to lnb driver
