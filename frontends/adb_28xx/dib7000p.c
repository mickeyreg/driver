...
#define dprintk(args...) do {printk("DiB7000P: ");printk(args);printk("\n");}while(0)
...
static int dib7000p_identify(struct dib7000p_state *st)
{
	...
	if ((value = dib7000p_read_word(st, 768)) != 0x01b3) {
		...
		dprintk( "Vendor ID (read=0x%x)",value);
...
static int dib7000p_read_signal_strength(struct dvb_frontend *fe, u16 *strength)
{
	...
	*strength = 65535 - val;
	printk("dib7000p_read_signal_strength:%d\n",*strength);
	return 0;
}
...
//dib7000p_read_ber:0
//dib7000p_read_snr:21300
//dib7000p_read_snr:20800
//dib7000p_read_signal_strength:28264

static int dib7000p_get_property(struct dvb_frontend *fe, struct dtv_property* tvp)
{
...
static struct dvb_frontend_ops dib7000p_ops = {
	...
	.get_property         = dib7000p_get_property,
